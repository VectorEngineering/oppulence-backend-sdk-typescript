...
```typescript
import { PutApiWorkspaceServiceV1AccountsAccountsResponse200Versions } from "oppulence-backend-sdk/models/operations";

let value: PutApiWorkspaceServiceV1AccountsAccountsResponse200Versions = {};
```
