...
```typescript
import { GetApiLeadScraperMicroserviceApiV1WorkspaceIdVariables } from "oppulence-backend-sdk/models/operations";

let value: GetApiLeadScraperMicroserviceApiV1WorkspaceIdVariables = {};
```
