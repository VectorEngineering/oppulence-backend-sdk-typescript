...
```typescript
import { GetApiWorkspaceServiceV1WorkspacesIdWorkspacesResponse200Versions } from "oppulence-backend-sdk/models/operations";

let value: GetApiWorkspaceServiceV1WorkspacesIdWorkspacesResponse200Versions =
  {};
```
