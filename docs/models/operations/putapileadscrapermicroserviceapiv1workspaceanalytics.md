...
```typescript
import { PutApiLeadScraperMicroserviceApiV1WorkspaceAnalytics } from "oppulence-backend-sdk/models/operations";

let value: PutApiLeadScraperMicroserviceApiV1WorkspaceAnalytics = {};
```
