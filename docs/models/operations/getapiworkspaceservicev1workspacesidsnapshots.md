...
```typescript
import { GetApiWorkspaceServiceV1WorkspacesIdSnapshots } from "oppulence-backend-sdk/models/operations";

let value: GetApiWorkspaceServiceV1WorkspacesIdSnapshots = {};
```
