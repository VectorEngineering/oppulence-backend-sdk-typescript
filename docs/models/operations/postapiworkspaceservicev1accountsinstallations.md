...
```typescript
import { PostApiWorkspaceServiceV1AccountsInstallations } from "oppulence-backend-sdk/models/operations";

let value: PostApiWorkspaceServiceV1AccountsInstallations = {};
```
