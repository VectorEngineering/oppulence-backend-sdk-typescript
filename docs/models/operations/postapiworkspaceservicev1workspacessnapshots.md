...
```typescript
import { PostApiWorkspaceServiceV1WorkspacesSnapshots } from "oppulence-backend-sdk/models/operations";

let value: PostApiWorkspaceServiceV1WorkspacesSnapshots = {};
```
