...
```typescript
import { PutApiWorkspaceServiceV1AccountsAccountsChanges } from "oppulence-backend-sdk/models/operations";

let value: PutApiWorkspaceServiceV1AccountsAccountsChanges = {};
```
