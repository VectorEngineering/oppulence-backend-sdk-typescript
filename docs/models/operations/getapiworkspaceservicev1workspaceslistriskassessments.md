...
```typescript
import { GetApiWorkspaceServiceV1WorkspacesListRiskAssessments } from "oppulence-backend-sdk/models/operations";

let value: GetApiWorkspaceServiceV1WorkspacesListRiskAssessments = {};
```
