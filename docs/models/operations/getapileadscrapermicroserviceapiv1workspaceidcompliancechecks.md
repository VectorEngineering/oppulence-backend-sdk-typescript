...
```typescript
import { GetApiLeadScraperMicroserviceApiV1WorkspaceIdComplianceChecks } from "oppulence-backend-sdk/models/operations";

let value: GetApiLeadScraperMicroserviceApiV1WorkspaceIdComplianceChecks = {};
```
