...
```typescript
import { PutApiLeadScraperMicroserviceApiV1AccountsUpdateRounds } from "oppulence-backend-sdk/models/operations";

let value: PutApiLeadScraperMicroserviceApiV1AccountsUpdateRounds = {};
```
