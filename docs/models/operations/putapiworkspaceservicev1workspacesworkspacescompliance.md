...
```typescript
import { PutApiWorkspaceServiceV1WorkspacesWorkspacesCompliance } from "oppulence-backend-sdk/models/operations";

let value: PutApiWorkspaceServiceV1WorkspacesWorkspacesCompliance = {};
```
