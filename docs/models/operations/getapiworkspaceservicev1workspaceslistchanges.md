...
```typescript
import { GetApiWorkspaceServiceV1WorkspacesListChanges } from "oppulence-backend-sdk/models/operations";

let value: GetApiWorkspaceServiceV1WorkspacesListChanges = {};
```
