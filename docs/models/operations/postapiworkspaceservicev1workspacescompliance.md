...
```typescript
import { PostApiWorkspaceServiceV1WorkspacesCompliance } from "oppulence-backend-sdk/models/operations";

let value: PostApiWorkspaceServiceV1WorkspacesCompliance = {};
```
