...
```typescript
import { PostApiLeadScraperMicroserviceApiV1WebhooksWebhooksIncludedFields } from "oppulence-backend-sdk/models/operations";

let value: PostApiLeadScraperMicroserviceApiV1WebhooksWebhooksIncludedFields =
