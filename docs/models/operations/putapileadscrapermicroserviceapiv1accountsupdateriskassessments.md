...
```typescript
import { PutApiLeadScraperMicroserviceApiV1AccountsUpdateRiskAssessments } from "oppulence-backend-sdk/models/operations";

let value: PutApiLeadScraperMicroserviceApiV1AccountsUpdateRiskAssessments = {};
```
