...
```typescript
import { Negotiation } from "oppulence-backend-sdk/models/operations";

let value: Negotiation = {};
```
...
| `rounds`                                                                                      | [operations.Rounds](../../models/operations/rounds.md)[]                                      | :heavy_minus_sign:                                                                            | N/A                                                                                           |
