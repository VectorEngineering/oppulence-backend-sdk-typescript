...
```typescript
import { GetApiWorkspaceServiceV1WorkspacesListVariables } from "oppulence-backend-sdk/models/operations";

let value: GetApiWorkspaceServiceV1WorkspacesListVariables = {};
```
