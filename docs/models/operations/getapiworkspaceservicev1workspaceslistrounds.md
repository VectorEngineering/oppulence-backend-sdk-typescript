...
```typescript
import { GetApiWorkspaceServiceV1WorkspacesListRounds } from "oppulence-backend-sdk/models/operations";

let value: GetApiWorkspaceServiceV1WorkspacesListRounds = {};
```
