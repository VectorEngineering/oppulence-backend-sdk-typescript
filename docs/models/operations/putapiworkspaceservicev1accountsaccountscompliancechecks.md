...
```typescript
import { PutApiWorkspaceServiceV1AccountsAccountsComplianceChecks } from "oppulence-backend-sdk/models/operations";

let value: PutApiWorkspaceServiceV1AccountsAccountsComplianceChecks = {};
```
