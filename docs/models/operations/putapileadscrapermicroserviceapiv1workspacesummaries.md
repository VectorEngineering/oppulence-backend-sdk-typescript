...
```typescript
import { PutApiLeadScraperMicroserviceApiV1WorkspaceSummaries } from "oppulence-backend-sdk/models/operations";

let value: PutApiLeadScraperMicroserviceApiV1WorkspaceSummaries = {};
```
