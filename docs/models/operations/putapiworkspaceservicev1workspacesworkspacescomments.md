...
```typescript
import { PutApiWorkspaceServiceV1WorkspacesWorkspacesComments } from "oppulence-backend-sdk/models/operations";

let value: PutApiWorkspaceServiceV1WorkspacesWorkspacesComments = {};
```
