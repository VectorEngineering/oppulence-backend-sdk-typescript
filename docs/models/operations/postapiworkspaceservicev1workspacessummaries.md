...
```typescript
import { PostApiWorkspaceServiceV1WorkspacesSummaries } from "oppulence-backend-sdk/models/operations";

let value: PostApiWorkspaceServiceV1WorkspacesSummaries = {};
```
