...
```typescript
import { GetApiWorkspaceServiceV1WorkspacesListCompliance } from "oppulence-backend-sdk/models/operations";

let value: GetApiWorkspaceServiceV1WorkspacesListCompliance = {};
```
