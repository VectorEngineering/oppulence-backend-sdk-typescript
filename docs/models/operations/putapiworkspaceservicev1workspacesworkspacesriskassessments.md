...
```typescript
import { PutApiWorkspaceServiceV1WorkspacesWorkspacesRiskAssessments } from "oppulence-backend-sdk/models/operations";

let value: PutApiWorkspaceServiceV1WorkspacesWorkspacesRiskAssessments = {};
```
