...
```typescript
import { PutApiLeadScraperMicroserviceApiV1WebhooksWebhooksIncludedFields } from "oppulence-backend-sdk/models/operations";

let value: PutApiLeadScraperMicroserviceApiV1WebhooksWebhooksIncludedFields =
