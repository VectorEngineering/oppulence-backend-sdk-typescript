# PostApiLeadScraperMicroserviceApiV1JobsStatus

## Example Usage

```typescript
import { PostApiLeadScraperMicroserviceApiV1JobsStatus } from "oppulence-backend-sdk/models/operations";

let value: PostApiLeadScraperMicroserviceApiV1JobsStatus =
