...
```typescript
import { PutApiWorkspaceServiceV1AccountsAccountsSummaries } from "oppulence-backend-sdk/models/operations";

let value: PutApiWorkspaceServiceV1AccountsAccountsSummaries = {};
```
