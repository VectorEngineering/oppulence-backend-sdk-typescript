...
```typescript
import { GetApiWorkspaceServiceV1WorkspacesListWorkspacesResponse200Versions } from "oppulence-backend-sdk/models/operations";

let value: GetApiWorkspaceServiceV1WorkspacesListWorkspacesResponse200Versions =
  {};
```
