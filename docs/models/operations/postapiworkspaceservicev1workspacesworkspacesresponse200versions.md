...
```typescript
import { PostApiWorkspaceServiceV1WorkspacesWorkspacesResponse200Versions } from "oppulence-backend-sdk/models/operations";

let value: PostApiWorkspaceServiceV1WorkspacesWorkspacesResponse200Versions =
  {};
```
