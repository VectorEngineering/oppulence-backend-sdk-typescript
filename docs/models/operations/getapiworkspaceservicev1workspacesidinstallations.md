...
```typescript
import { GetApiWorkspaceServiceV1WorkspacesIdInstallations } from "oppulence-backend-sdk/models/operations";

let value: GetApiWorkspaceServiceV1WorkspacesIdInstallations = {};
```
