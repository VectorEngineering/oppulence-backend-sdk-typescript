...
```typescript
import { PostApiWorkspaceServiceV1WorkspacesAnalytics } from "oppulence-backend-sdk/models/operations";

let value: PostApiWorkspaceServiceV1WorkspacesAnalytics = {};
```
