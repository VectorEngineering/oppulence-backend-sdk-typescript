...
```typescript
import { PutApiWorkspaceServiceV1WorkspacesWorkspacesVariables } from "oppulence-backend-sdk/models/operations";

let value: PutApiWorkspaceServiceV1WorkspacesWorkspacesVariables = {};
```
