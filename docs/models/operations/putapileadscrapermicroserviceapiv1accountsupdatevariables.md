...
```typescript
import { PutApiLeadScraperMicroserviceApiV1AccountsUpdateVariables } from "oppulence-backend-sdk/models/operations";

let value: PutApiLeadScraperMicroserviceApiV1AccountsUpdateVariables = {};
```
