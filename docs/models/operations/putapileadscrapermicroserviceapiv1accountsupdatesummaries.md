...
```typescript
import { PutApiLeadScraperMicroserviceApiV1AccountsUpdateSummaries } from "oppulence-backend-sdk/models/operations";

let value: PutApiLeadScraperMicroserviceApiV1AccountsUpdateSummaries = {};
```
