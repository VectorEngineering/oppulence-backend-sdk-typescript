...
```typescript
import { PutApiLeadScraperMicroserviceApiV1AccountsUpdateIncludedFields } from "oppulence-backend-sdk/models/operations";

let value: PutApiLeadScraperMicroserviceApiV1AccountsUpdateIncludedFields =
