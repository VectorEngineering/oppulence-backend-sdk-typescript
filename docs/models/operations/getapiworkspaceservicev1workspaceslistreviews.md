...
```typescript
import { GetApiWorkspaceServiceV1WorkspacesListReviews } from "oppulence-backend-sdk/models/operations";

let value: GetApiWorkspaceServiceV1WorkspacesListReviews = {};
```
