...
```typescript
import { GetApiLeadScraperMicroserviceApiV1AccountsListIncludedFields } from "oppulence-backend-sdk/models/operations";

let value: GetApiLeadScraperMicroserviceApiV1AccountsListIncludedFields =
