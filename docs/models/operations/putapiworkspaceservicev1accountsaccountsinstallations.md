...
```typescript
import { PutApiWorkspaceServiceV1AccountsAccountsInstallations } from "oppulence-backend-sdk/models/operations";

let value: PutApiWorkspaceServiceV1AccountsAccountsInstallations = {};
```
