...
```typescript
import { GetApiLeadScraperMicroserviceApiV1OrganizationIncludedFields } from "oppulence-backend-sdk/models/operations";

let value: GetApiLeadScraperMicroserviceApiV1OrganizationIncludedFields =
