...
```typescript
import { PutApiLeadScraperMicroserviceApiV1WorkspaceAiAssistance } from "oppulence-backend-sdk/models/operations";

let value: PutApiLeadScraperMicroserviceApiV1WorkspaceAiAssistance = {};
```
