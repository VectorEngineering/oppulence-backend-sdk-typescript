...
```typescript
import { PostApiLeadScraperMicroserviceApiV1OrganizationIncludedFields } from "oppulence-backend-sdk/models/operations";

let value: PostApiLeadScraperMicroserviceApiV1OrganizationIncludedFields =
