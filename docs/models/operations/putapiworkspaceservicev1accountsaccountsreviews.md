...
```typescript
import { PutApiWorkspaceServiceV1AccountsAccountsReviews } from "oppulence-backend-sdk/models/operations";

let value: PutApiWorkspaceServiceV1AccountsAccountsReviews = {};
```
