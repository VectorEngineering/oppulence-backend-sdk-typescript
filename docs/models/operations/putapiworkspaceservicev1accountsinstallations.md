...
```typescript
import { PutApiWorkspaceServiceV1AccountsInstallations } from "oppulence-backend-sdk/models/operations";

let value: PutApiWorkspaceServiceV1AccountsInstallations = {};
```
