...
```typescript
import { GetApiLeadScraperMicroserviceApiV1WorkspaceIdWorkspacesVersions } from "oppulence-backend-sdk/models/operations";

let value: GetApiLeadScraperMicroserviceApiV1WorkspaceIdWorkspacesVersions = {};
```
