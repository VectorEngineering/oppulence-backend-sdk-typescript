...
```typescript
import { GetApiWorkspaceServiceV1WorkspacesIdComments } from "oppulence-backend-sdk/models/operations";

let value: GetApiWorkspaceServiceV1WorkspacesIdComments = {};
```
