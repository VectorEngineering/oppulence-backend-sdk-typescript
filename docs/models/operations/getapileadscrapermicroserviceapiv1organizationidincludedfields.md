...
```typescript
import { GetApiLeadScraperMicroserviceApiV1OrganizationIdIncludedFields } from "oppulence-backend-sdk/models/operations";

let value: GetApiLeadScraperMicroserviceApiV1OrganizationIdIncludedFields =
