...
```typescript
import { PutApiLeadScraperMicroserviceApiV1WorkspaceComplianceChecks } from "oppulence-backend-sdk/models/operations";

let value: PutApiLeadScraperMicroserviceApiV1WorkspaceComplianceChecks = {};
```
