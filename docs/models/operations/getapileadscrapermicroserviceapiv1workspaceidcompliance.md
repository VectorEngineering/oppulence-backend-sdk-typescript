...
```typescript
import { GetApiLeadScraperMicroserviceApiV1WorkspaceIdCompliance } from "oppulence-backend-sdk/models/operations";

let value: GetApiLeadScraperMicroserviceApiV1WorkspaceIdCompliance = {};
```
