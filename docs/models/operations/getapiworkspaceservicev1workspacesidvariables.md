...
```typescript
import { GetApiWorkspaceServiceV1WorkspacesIdVariables } from "oppulence-backend-sdk/models/operations";

let value: GetApiWorkspaceServiceV1WorkspacesIdVariables = {};
```
