# PostApiLeadScraperMicroserviceApiV1AccountsIncludedFields

## Example Usage

```typescript
import { PostApiLeadScraperMicroserviceApiV1AccountsIncludedFields } from "oppulence-backend-sdk/models/operations";

let value: PostApiLeadScraperMicroserviceApiV1AccountsIncludedFields =
  "INCLUDED_FIELD_NAME";
```
