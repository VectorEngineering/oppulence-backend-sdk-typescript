...
```typescript
import { GetApiWorkspaceServiceV1WorkspacesListSnapshots } from "oppulence-backend-sdk/models/operations";

let value: GetApiWorkspaceServiceV1WorkspacesListSnapshots = {};
```
