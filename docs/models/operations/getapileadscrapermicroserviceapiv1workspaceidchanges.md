...
```typescript
import { GetApiLeadScraperMicroserviceApiV1WorkspaceIdChanges } from "oppulence-backend-sdk/models/operations";

let value: GetApiLeadScraperMicroserviceApiV1WorkspaceIdChanges = {};
```
