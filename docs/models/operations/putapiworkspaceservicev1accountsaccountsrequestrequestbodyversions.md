...
```typescript
import { PutApiWorkspaceServiceV1AccountsAccountsRequestRequestBodyVersions } from "oppulence-backend-sdk/models/operations";

let value: PutApiWorkspaceServiceV1AccountsAccountsRequestRequestBodyVersions =
  {};
```
