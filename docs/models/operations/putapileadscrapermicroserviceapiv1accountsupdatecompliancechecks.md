...
```typescript
import { PutApiLeadScraperMicroserviceApiV1AccountsUpdateComplianceChecks } from "oppulence-backend-sdk/models/operations";

let value: PutApiLeadScraperMicroserviceApiV1AccountsUpdateComplianceChecks =
  {};
```
