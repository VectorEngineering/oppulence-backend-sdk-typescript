...
```typescript
import { GetApiWorkspaceServiceV1WorkspacesIdSummaries } from "oppulence-backend-sdk/models/operations";

let value: GetApiWorkspaceServiceV1WorkspacesIdSummaries = {};
```
