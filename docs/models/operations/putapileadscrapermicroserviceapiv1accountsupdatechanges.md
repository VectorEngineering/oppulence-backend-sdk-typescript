...
```typescript
import { PutApiLeadScraperMicroserviceApiV1AccountsUpdateChanges } from "oppulence-backend-sdk/models/operations";

let value: PutApiLeadScraperMicroserviceApiV1AccountsUpdateChanges = {};
```
