...
```typescript
import { GetApiLeadScraperMicroserviceApiV1WebhooksWebhookIdIncludedFields } from "oppulence-backend-sdk/models/operations";

let value: GetApiLeadScraperMicroserviceApiV1WebhooksWebhookIdIncludedFields =
