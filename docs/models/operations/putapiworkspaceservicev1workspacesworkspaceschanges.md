...
```typescript
import { PutApiWorkspaceServiceV1WorkspacesWorkspacesChanges } from "oppulence-backend-sdk/models/operations";

let value: PutApiWorkspaceServiceV1WorkspacesWorkspacesChanges = {};
```
