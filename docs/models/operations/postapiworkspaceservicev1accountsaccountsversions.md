...
```typescript
import { PostApiWorkspaceServiceV1AccountsAccountsVersions } from "oppulence-backend-sdk/models/operations";

let value: PostApiWorkspaceServiceV1AccountsAccountsVersions = {};
```
