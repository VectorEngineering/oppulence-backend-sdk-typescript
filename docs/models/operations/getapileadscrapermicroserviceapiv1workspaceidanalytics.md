...
```typescript
import { GetApiLeadScraperMicroserviceApiV1WorkspaceIdAnalytics } from "oppulence-backend-sdk/models/operations";

let value: GetApiLeadScraperMicroserviceApiV1WorkspaceIdAnalytics = {};
```
