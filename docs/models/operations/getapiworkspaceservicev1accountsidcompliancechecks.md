...
```typescript
import { GetApiWorkspaceServiceV1AccountsIdComplianceChecks } from "oppulence-backend-sdk/models/operations";

let value: GetApiWorkspaceServiceV1AccountsIdComplianceChecks = {};
```
