...
```typescript
import { PostApiWorkspaceServiceV1AccountsAiAssistance } from "oppulence-backend-sdk/models/operations";

let value: PostApiWorkspaceServiceV1AccountsAiAssistance = {};
```
